...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/list.do" method="get">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<itcast:page url="${pageContext.request.contextPath }/list" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		...
		function updateCustomer() {
			//$("#edit_customer_form").serialize()把表单数据变成http请求体数据格式(username=jack&age=11&sex=男)
			//http请求体:正常提交form表单:username=jack&age=11&sex=男(浏览器)
			console.log($("#edit_customer_form").serialize());
			var params = decodeURIComponent($("#edit_customer_form").serialize(),true);
			console.log(params);
